...
class ObstacleViz(Node):
    ...
    def __init__(self) -> None:
        ...
        self.create_subscription(Bool, topics.avoidance_active, self._avoid_cb, QOS_SUB)
        self.create_subscription(Path, topics.avoidance_planned_path, self._plan_cb, QOS_SUB)
        self.create_subscription(Path, topics.avoidance_actual_path, self._actual_cb, QOS_SUB)
        if subscribe_legacy:
            self.create_subscription(
